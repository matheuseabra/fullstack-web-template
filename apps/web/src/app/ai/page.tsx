...
import { env } from "@web-stack-template/env/web";
import { Bubble, BubbleContent } from "@web-stack-template/ui/components/bubble";
import { Button } from "@web-stack-template/ui/components/button";
import {
  Empty,
  EmptyDescription,
  EmptyHeader,
  EmptyMedia,
  EmptyTitle,
} from "@web-stack-template/ui/components/empty";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@web-stack-template/ui/components/input-group";
import {
  Message,
  MessageContent as MessageBody,
  MessageHeader,
} from "@web-stack-template/ui/components/message";
import {
  MessageScroller,
...
} from "@web-stack-template/ui/components/message-scroller";
import { Tooltip, TooltipContent, TooltipTrigger } from "@web-stack-template/ui/components/tooltip";
          ...
          {messages.length === 0 && !isSending ? (
            <Empty className="mx-auto h-full max-w-3xl px-4">
              <EmptyHeader>
                ...
                <EmptyTitle>Morning, web-stack-template!</EmptyTitle>
